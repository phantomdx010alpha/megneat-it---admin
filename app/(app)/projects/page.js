 ...
 *
 * ── ADMIN_STATIC.md (device-delete/project-edit track), Phase 4 ─────────
 * Adds the entry point for the new edit screen — a small "Edit" button per
 * project row, alongside (not replacing) the existing pause/unpause
 * toggle, navigating to `/projects/[id]/edit`. This page itself gained no
 * new server actions or edit logic; all of that lives in the new edit
 * page and in actions.js's own `updateProjectAction`/`getProjectForEditAction`.
 */

import { useCallback, useEffect, useState } from 'react';
import { useRouter } from 'next/navigation';
import { Plus, ArrowLeft, CheckCircle, XCircle, WarningCircle, PauseCircle, PlayCircle, PencilSimpleLine } from '@phosphor-icons/react';
